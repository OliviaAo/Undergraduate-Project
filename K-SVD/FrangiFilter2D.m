...
defaultoptions = struct('FrangiScaleRange', [1 3], 'FrangiScaleRatio', 0.2, 'FrangiBetaOne', 0.9, 'FrangiBetaTwo', 8, 'verbose',true,'BlackWhite',true);
...
for i = 1:length(sigmas),
   ...
   % Ifiltered = exp(-(Lambda2./Lambda1 - 1).^2/beta) .*(ones(size(I))-exp(-(Lambda2.^2 + Lambda1.^2)/c));
    % see pp. 45
