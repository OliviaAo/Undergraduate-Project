...
%         disp(['1¡¢min: ',num2str(min(D(:,counter))),'max: ',num2str(max(D(:,counter)))]);
        D(:,counter) = D(:,counter)-min(D(:,counter));
        
%         disp(['2¡¢min: ',num2str(min(D(:,counter))),'max: ',num2str(max(D(:,counter)))]);
        if (max(D(:,counter)))
            D(:,counter) = D(:,counter)./max(D(:,counter));
%             disp(['hihihi']); 
        end
%         disp(['3¡¢min: ',num2str(min(D(:,counter))),'max: ',num2str(max(D(:,counter)))]);
    end
    disp(['Come in1']);
end
